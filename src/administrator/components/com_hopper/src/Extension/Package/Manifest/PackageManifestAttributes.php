...
class PackageManifestAttributes implements ManifestAttributesInterface
{
    ...
    public function getAttributes(): array
    {
        ...
        return [
            'name' => $this->packageHelper->getProjectAlias(),
            'packagename' => 'hopper_' . $this->packageHelper->getProjectAlias(),
            ...
            'filesPackageId' => basename($this->packageHelper->filesManifestName(), '.xml')
        ];
    }
}